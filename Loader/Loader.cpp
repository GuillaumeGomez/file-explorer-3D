...
{
  objList.push_back(ObjectFactory::createCharacter<Model, Vector3D, Rotation, const char*, float>(Vector3D(0.f, 20.f, 10.f), Rotation(), "models/guard/boblampclean.md5mesh", 3.f));
